...
### CDP gathers from Viking graben data after appropriate preprocessing
...
cdpfirst=401	# minimum cdp value in data : EDIT THIS!
cdplast=500		# maximum cdp value in data : EDIT THIS!
cdpmin=401		# minimum cdp value used in velocity analysis : EDIT THIS!
cdpmax=500		# maximum cdp value used in velocity analysis : EDIT THIS!
dcdp=25		# change in cdp for velocity scans : EDIT THIS!
...
## set filter values
f=1,18,80,100		# bandwidth of data to pass
...
do
	...
	do
		...
		suxwigb < panel.$cdp title="CDP gather for cdp=$cdp" \
				...
				perc=$perc  wbox=300 &
		sufilter  < panel.$cdp f=$f amps=$amps |
        ...
        sunmo < panel.$cdp par=par.$cdp smute=2.0 |
